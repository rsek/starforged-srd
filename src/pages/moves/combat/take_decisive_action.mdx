...
| Roll   | Result                                                                                           |
| ------ | ------------------------------------------------------------------------------------------------ |
| 1-40   | It’s worse than you thought: Make a <RouterLink to='/moves/suffer'>suffer move</RouterLink> (-2) |
...
On a **miss**, you are defeated or your objective is lost. <RouterLink to='/moves/fate/pay_the_price'>Pay the Price</RouterLink>.
