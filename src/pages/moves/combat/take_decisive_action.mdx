...
| Roll   | Result                                                                               |
| ------ | ------------------------------------------------------------------------------------ |
| 1-40   | It’s worse than you thought: Make a [suffer move](/starforged-srd/moves/suffer) (-2) |
...
On a **miss**, you are defeated or your objective is lost. [Pay the Price](/starforged-srd/moves/fate/pay_the_price).
