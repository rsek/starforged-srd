...
On a **weak hit**, you avoid the worst of the danger or overcome the obstacle, but not without a cost. Make a <RouterLink to='/moves/suffer'>suffer move</RouterLink> (-1). You stay in a bad spot.

On a **miss**, the situation worsens. You stay in a bad spot and must <RouterLink to='/moves/fate/pay_the_price'>Pay the Price</RouterLink>.
