...
On a **weak hit**, you achieve your objective, but not without cost. <RouterLink to='/moves/fate/pay_the_price'>Pay the Price</RouterLink>.

On a **miss**, you are defeated or the objective is lost. <RouterLink to='/moves/fate/pay_the_price'>Pay the Price</RouterLink>.
