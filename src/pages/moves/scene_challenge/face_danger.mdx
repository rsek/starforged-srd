...
On a **miss**, you fail, or a momentary success is undermined by a dramatic turn of events. Fill a clock segment and <RouterLink to='/moves/fate/pay_the_price'>Pay the Price</RouterLink>. On a **miss with a match**, fill two segments and <RouterLink to='/moves/fate/pay_the_price'>Pay the Price</RouterLink>.
