...
- <RouterLink to="/moves/fate/ask_the_oracle">Ask the Oracle</RouterLink> for inspiration.
  Interpret the answer as a hardship or complication appropriate to the situation.
