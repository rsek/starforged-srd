...
- You are demoralized or dispirited: <RouterLink to='/moves/suffer/endure_stress'>Endure Stress</RouterLink>.
- A connection loses faith: <RouterLink to='/moves/connection/test_your_relationship'>Test Your Relationship</RouterLink> when you next interact.
