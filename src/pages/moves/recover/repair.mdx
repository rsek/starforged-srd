...
On a **hit**, you gain repair points as appropriate to the situation, per the table below. Additionally, you may <RouterLink to='/moves/suffer/sacrifice_resources'>Sacrifice Resources</RouterLink> and exchange each -1 of supply for 1 extra repair point (up to 3 points).
...
On a **miss**, the repairs are not made and the situation worsens. <RouterLink to='/moves/fate/pay_the_price'>Pay the Price</RouterLink>.
