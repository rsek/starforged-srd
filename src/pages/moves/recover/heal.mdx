...
On a **weak hit**, as above, but the recovery costs extra time or resources. Choose one: <RouterLink to='/moves/suffer/lose_momentum'>Lose Momentum</RouterLink> (-2) or <RouterLink to='/moves/suffer/sacrifice_resources'>Sacrifice Resources</RouterLink> (-2).

On a **miss**, the aid is ineffective and the situation worsens. <RouterLink to='/moves/fate/pay_the_price'>Pay the Price</RouterLink>.
