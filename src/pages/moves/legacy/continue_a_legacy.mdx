...
- See it through: Choose one of the former character's unfinished quests, and <RouterLink to='/moves/quest/swear_an_iron_vow'>Swear an Iron Vow</RouterLink> (with an automatic strong hit) to see it done. You may immediately mark up to half their earned progress (round down) on this quest.
- Rebuild a connection: Name one of the former character's connections, and envision how time or circumstances have changed them in a dramatic way. When you <RouterLink to='/moves/connection/make_a_connection'>Make a Connection</RouterLink> with them, take an automatic strong hit and mark two ticks on your bonds legacy track.
